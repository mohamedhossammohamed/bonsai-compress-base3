...
# Self-generated local API key (created on first run, never shipped).
# Override location with BONSAI_API_KEY_FILE.
API_KEY_FILE = Path(os.environ.get("BONSAI_API_KEY_FILE",
                                   RUNTIME_DIR / ".bonsai_api_key"))
...
if not API_KEY_FILE.exists():
    ...
    print(f"[*] Loaded existing API Key from {API_KEY_FILE}")
